...
<body>
    <?php
        ...
        $replacements = [
            ...
            '/<tr class="h"><th>(.*?)<\/th><th>enabled<\/th><\/tr>/' => '<tr class="h"><th>$1</th><th class="enabled-mod">enabled</th></tr>',
        ...
        $insertHtml = '<div id="logo-text">
            <a href="https://github.com/BlagoYar/beautiful_phpinfo" class="logo-text" target="_blank" rel="noopener noreferrer">Designed by BlagoYar</a>
        </div>';
        $phpinfo .= "\n" . $insertHtml; // Добавляем в конец phpinfo
